...
const SongDetails = () => {
    ...
    <div className="flex flex-col">
        ...
        {
          Object.keys(data).length > 0 ? (<RelatedSongs data={data} isPlaying={isPlaying} activeSong={activeSong} handlePauseClick={handlePauseClick} handlePlayClick={handlePlayClick} />) : ''
        }
    </div>
  )  
};
